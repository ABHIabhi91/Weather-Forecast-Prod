package com.example.weatherforecast.weatherforecast.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.inMemoryAuthentication().withUser("abhishek").password("{noop}abhishek").roles("USER").and().withUser("admin")
